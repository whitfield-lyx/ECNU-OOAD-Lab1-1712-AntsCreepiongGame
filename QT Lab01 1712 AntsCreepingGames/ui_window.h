...
public:
    ...
    void setupUi(QDialog *window)
    {
        ...
        QFont font5;
        font5.setFamily(QString::fromUtf8("\345\215\216\346\226\207\347\273\206\351\273\221"));
